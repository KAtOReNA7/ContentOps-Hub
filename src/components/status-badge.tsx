import { badgeToneClasses, type BadgeTone } from "@/lib/ui/status-maps";
...
export function StatusBadge({ children, title, tone = "stone" }: StatusBadgeProps) {
  return (
    <span
      className={`inline-flex max-w-full items-center rounded-md px-2.5 py-1 text-xs font-medium ring-1 ring-inset ${badgeToneClasses[tone]}`}
      title={title}
    >
